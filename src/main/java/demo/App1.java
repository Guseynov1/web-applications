...
public class App1 {
    ...
    public class Addresses {
         ...
         * @Qualifier - позволяет нам указать имя компонента, который нам нужно использовать
         */
        @Bean
...
/**
 * Мы все еще можете использовать стандартные объекты, создавая их вручную в соответствии с подходом ООП:
 * String address = "Green Street, 102";
 * Customer customer = new Customer("Ben Miller", address);
 * бобы обычно используются для формирования основы вашего приложения и разделения его по слоям и файлам конфигурации,
